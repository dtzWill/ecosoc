...
class IntraProceduralRACousot : public IntraProceduralRA<Cousot> {
public:
  IntraProceduralRACousot() : IntraProceduralRA<Cousot>() {
    // initializeIntraProceduralRACousotPass(*PassRegistry::getPassRegistry());
  }
  void getAnalysisUsage(AnalysisUsage &AU) const {
    AU.addRequired<vSSA>();
    AU.setPreservesAll();
...
class InterProceduralRACousot : public InterProceduralRA<Cousot> {
public:
  InterProceduralRACousot() : InterProceduralRA<Cousot>() {
    // initializeInterProceduralRACousotPass(*PassRegistry::getPassRegistry());
  }
  void getAnalysisUsage(AnalysisUsage &AU) const {
    AU.addRequired<vSSA>();
    AU.setPreservesAll();
